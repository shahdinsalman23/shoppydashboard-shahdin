...
const Notification = () => {
  ...
  const closeNotification = () => setIsClicked((prev) => ({ ...prev, notification: false }));
  ...
  return (
    <div className="nav-item absolute right-5 md:right-40 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      <div className="flex justify-between items-center">
        ...
        <button type="button" onClick={closeNotification} style={{ color: 'rgb(153, 171, 180)', borderRadius: '50%' }} className='text-2xl p-3 hover:drop-shadow-xl hover:bg-light-gray'>
          <MdOutlineCancel />
        </button>
      </div>
      <div className="mt-5 ">
