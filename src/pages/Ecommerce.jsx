...
import { earningData, SparklineAreaData, ecomPieChartData, medicalproBranding, dropdownData, recentTransactions, weeklyStats } from '../data/dummy';
      ...
      <div className='flex gap-10 flex-wrap justify-center'>
        ...
        <div>
          ...
          <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl md:w-400 p-8 m-3 flex justify-center items-center gap-10">
            ...
            <div className="w-40">
              <PieChart id="pie-chart" data={ecomPieChartData} legendVisiblity={false} dataLabel={{ visible: false }} height="160px" />
            </div>
          </div>
        </div>
      </div>
